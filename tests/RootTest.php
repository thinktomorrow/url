...
class RootTest extends TestCase
{
    ...
    public function test_it_normalizes_domain_to_complete_root()
    {
        $urls = [
    ...
    public function test_it_can_set_root_as_secure()
    {
        $urls = [
            'example.com' => 'https://example.com',
    ...
    public function test_it_can_validate_root()
    {
    ...
    public function test_it_can_validate_root_for_hashtag()
    {
        $this->assertFalse(Root::fromString('#')->isValid());
    }
    ...
    public function test_it_throws_exception_if_url_cannot_be_parsed()
    {
    ...
    public function test_it_can_get_scheme()
    {
        $urls = [
            'example.com' => null,
            '//example.com' => null,
